...
async def fiyat_gonder(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await update.message.reply_text("❌ Fiyat hatası.")
...
async def ciz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            await update.message.reply_text("💤 AI Meşgul, 1 dk sonra tekrar dene (Uyanıyor).")
    except:
...
def main():
    ...
    # BOTU KURUYORUZ
    # run_polling komutu en sağlam ve güncel yöntemdir
